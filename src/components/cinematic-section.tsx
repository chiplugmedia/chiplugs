...
>
  ...
  <span className="bg-gradient-to-br from-[#ffd6b5] via-[#fba03d] to-[#fb7507] text-transparent bg-clip-text">
    Bug
  </span>
  <br />
  {/* Sub-title with same gradient and lower opacity */}
  <span className="bg-gradient-to-br from-[#ffd6b5] via-[#fba03d] to-[#fb7507] text-transparent bg-clip-text opacity-50">
    Origins
  </span>
</motion.h2>
              ...
              >
                The term “bug” came from a real moth stuck in a computer in 1947. Grace Hopper literally found the first “computer bug.”
              </motion.p>
            </div>
